...
class ReactionTest {
    private val debugReactive = createMutableReactive(false)
    private var debug by debugReactive
    ...
    private val contextManager = createContextManager().apply {
        findAndRegisterModules()
    }

    @Test
    fun testReaction() {
        val root = contextManager.enterRoot(DebugMonitor())
